...
import grillo78.beycraft.client.block.BattleInformerRenderer;
import grillo78.beycraft.client.block.BeycreatorRenderer;
import grillo78.beycraft.client.block.ExpositoryRenderer;
import grillo78.beycraft.client.entity.BeybladeRenderer;
import grillo78.beycraft.client.particle.ResonanceParticle;
import grillo78.beycraft.client.particle.SparkleParticle;
import grillo78.beycraft.client.screen.*;
import grillo78.beycraft.client.util.BeyPartModel;
import grillo78.beycraft.client.util.KeyBinds;
import grillo78.beycraft.common.block.ModBlocks;
import grillo78.beycraft.common.block_entity.ModTileEntities;
...
import grillo78.beycraft.common.capability.entity.BladerStorage;
...
import grillo78.beycraft.common.entity.ModEntities;
...
import grillo78.beycraft.common.ranking.Level;
import grillo78.beycraft.common.sound.ModSounds;
import grillo78.beycraft.common.stats.CustomStats;
import grillo78.beycraft.network.PacketHandler;
import grillo78.beycraft.network.message.MessageActivateLaunch;
import grillo78.beycraft.network.message.MessageActivateResonance;
import grillo78.beycraft.network.message.MessageHandSpinning;
import grillo78.beycraft.network.message.MessageOpenBeltContainer;
import grillo78.beycraft.utils.ClientUtils;
import grillo78.beycraft.utils.Config;
        ...
        if (!Minecraft.getInstance().options.renderDebug) {
            if (event.getType() == RenderGameOverlayEvent.ElementType.ALL) {
                Minecraft.getInstance().player.getCapability(BladerCapabilityProvider.BLADER_CAP).ifPresent(cap -> {
                    ...
                    float i = 1-(h.getExpForNextLevel() - h.getExperience()) / h.getExpForNextLevel();
                    AbstractGui.blit(event.getMatrixStack(), 1, 27, 0, 74, 75, 5, 105, 256);
                    AbstractGui.blit(event.getMatrixStack(), 1, 27, 0, 79, (int) (75F*i), 5, 105, 256);
                });
            }
        }
    }
