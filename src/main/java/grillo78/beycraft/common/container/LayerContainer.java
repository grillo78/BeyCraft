...
import grillo78.beycraft.common.container.slot.DiscSlot;
import grillo78.beycraft.common.container.slot.DriverSlot;
import grillo78.beycraft.common.container.slot.LockedSlot;
...
public class LayerContainer extends Container {
    ...
    protected void addSlots(IItemHandler cap) {
        this.addSlot(new DiscSlot(cap, 0, 10, 15));
        this.addSlot(new DriverSlot(cap, 1, 10, 35));
    }
