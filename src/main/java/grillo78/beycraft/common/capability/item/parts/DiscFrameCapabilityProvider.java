package grillo78.beycraft.common.capability.item.parts;
...
public class DiscFrameCapabilityProvider implements ICapabilityProvider, ICapabilitySerializable {

    private final LazyOptional<IItemHandler> inventory;

    public DiscFrameCapabilityProvider(IItemHandler inventory) {
