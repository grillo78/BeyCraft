...
public class ModTileEntities {
    ...
    public static final TileEntityType<StadiumTileEntity> STADIUM = register("stadium",  TileEntityType.Builder.of(StadiumTileEntity::new, ModBlocks.STADIUM).build(null));
