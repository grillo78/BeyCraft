...
import grillo78.beycraft.items.x.Bit;
import grillo78.beycraft.items.x.Blade;
import grillo78.beycraft.items.x.Ratchet;
...
public class ModItems {
    ...
    public static final DeferredHolder<Item, Launcher> LAUNCHER = register("launcher", () -> new Launcher(new Item.Properties()));
    ...
    public static final DeferredHolder<Item, Item> X_BLADE = register("x_blade", () -> new Blade(new Item.Properties()));
    public static final DeferredHolder<Item, Item> X_RATCHET = register("x_ratchet", () -> new Ratchet(new Item.Properties()));
    public static final DeferredHolder<Item, Item> X_BIT = register("x_bit", () -> new Bit(new Item.Properties()));
