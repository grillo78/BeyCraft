...
public class RobotBlock extends Block implements IHasModel {

	public static final PropertyEnum<RobotBlock.EnumPartType> PART = PropertyEnum.<RobotBlock.EnumPartType>create(
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		if (worldIn.getBlockState(pos.north()).getBlock() instanceof RobotBlock) {
			worldIn.setBlockToAir(pos.north());
		}
		if (worldIn.getBlockState(pos.south()).getBlock() instanceof RobotBlock) {
			worldIn.setBlockToAir(pos.south());
		}
		if (worldIn.getBlockState(pos.west()).getBlock() instanceof RobotBlock) {
			worldIn.setBlockToAir(pos.west());
		}
		if (worldIn.getBlockState(pos.east()).getBlock() instanceof RobotBlock) {
