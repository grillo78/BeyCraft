...
public class CommonEvents {
    ...
    public static void registerTileEntityType(final RegistryEvent.Register<TileEntityType<?>> event) {
        ...
        event.getRegistry().register((TileEntityType<ExpositoryTileEntity>) TileEntityType.Builder
                .create(BeyCreatorTileEntity::new, BeyRegistry.BEYCREATORBLOCK)
                .build(null)
    ...
    public static void onContainerRegistry(final RegistryEvent.Register<ContainerType<?>> event) {
        ...
        try {
            ...
            event.getRegistry().register(IForgeContainerType.create((windowId, inv, data) -> {
                return new BeltContainer(BeyRegistry.BELT_CONTAINER, windowId, new ItemStack(BeyRegistry.ITEMS.get("belt")), inv, true);
