...
public class MessageUpdateHandleItemStack implements IMessage<MessageUpdateHandleItemStack> {
    ...
    public MessageUpdateHandleItemStack(ItemStack stack, ItemStack slot1, ItemStack slot2, ItemStack slot3, Hand hand){
    ...
    public MessageUpdateHandleItemStack decode(PacketBuffer buffer) {
        return new MessageUpdateHandleItemStack(buffer.readItemStack(),buffer.readItemStack(),buffer.readItemStack(),buffer.readItemStack(),buffer.readEnumValue(Hand.class));
    }
