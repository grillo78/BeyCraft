...
import com.grillo78.beycraft.ranking.RankingBlader;
import com.grillo78.beycraft.util.RankingUtil;
...
public class RankingScreen extends Screen {
    ...
    private class List extends ExtendedList<RankingBlader>{
        ...
        public List() {
            super(Minecraft.getInstance(), RankingScreen.this.width, RankingScreen.this.height/3, 90, RankingScreen.this.height - 30, 18);
            getRanking();
