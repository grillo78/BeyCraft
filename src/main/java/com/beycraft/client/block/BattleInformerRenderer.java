package com.beycraft.client.block;
...
public class BattleInformerRenderer extends TileEntityRenderer<BattleInformerTileEntity> {

    public BattleInformerRenderer(TileEntityRendererDispatcher p_i226006_1_) {
        super(p_i226006_1_);
    }
