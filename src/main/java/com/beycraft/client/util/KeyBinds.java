...
public class KeyBinds {
    ...
    public static final KeyBinding ACTIVATE_LAUNCH = new KeyBinding("key." + Beycraft.MOD_ID + ".ativate_launch", GLFW.GLFW_KEY_APOSTROPHE, "key." + Beycraft.MOD_ID + ".category");
