...
public class LaunchTypes {
    ...
    public static final LaunchType RUSH_LAUNCH_TYPE = register("basic_attack_launch_type", new LaunchType(BasicAttackLaunch::new));
    public static final LaunchType FLASH_LAUNCH_TYPE = register("flower_attack_launch_type", new LaunchType(FlowerAttackLaunch::new));
