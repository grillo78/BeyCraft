...
import ga.beycraft.common.container.slot.BeySlot;
import ga.beycraft.common.container.slot.DiscSlot;
import ga.beycraft.common.container.slot.DriverSlot;
import ga.beycraft.common.container.slot.LockedSlot;
...
public class LauncherContainer extends Container {
    ...
    protected void addSlots(IItemHandler cap) {
        this.addSlot(new BeySlot(cap, 0, 10, 15));
    }
