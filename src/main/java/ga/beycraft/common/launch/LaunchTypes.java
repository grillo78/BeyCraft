...
public class LaunchTypes {
    ...
    public static final LaunchType FLASH_LAUNCH_TYPE = register("flash_launch_type", new LaunchType(FlashLaunch::new, 25,75, new ResourceLocation(Beycraft.MOD_ID, "rush_launch_type")));
