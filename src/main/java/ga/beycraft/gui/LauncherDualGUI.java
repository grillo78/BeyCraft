...
import ga.beycraft.items.ItemDualLauncher;
import ga.beycraft.network.PacketHandler;
import ga.beycraft.network.message.MessageUpdateColorLauncher;
import ga.beycraft.network.message.MessageUpdateDualLauncher;
...
public class LauncherDualGUI extends ContainerScreen<LauncherContainer> {
	...
	protected void renderBg(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
		...
		this.getMinecraft().getTextureManager()
				.bind(new ResourceLocation(Reference.MOD_ID, "textures/gui/container/launcher.png"));
		int relX = (this.width - this.imageWidth) / 2;
		int relY = (this.height - this.imageHeight) / 2;
