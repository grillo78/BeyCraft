...
import ga.beycraft.inventory.BeyGTContainer;
...
public class BeyGTGUI extends ContainerScreen<BeyGTContainer>{
	...
	protected void renderBg(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) {
		...
		this.getMinecraft().getTextureManager().bind(new ResourceLocation(Reference.MOD_ID, "textures/gui/container/4_slots.png"));
