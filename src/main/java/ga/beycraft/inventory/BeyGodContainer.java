...
import ga.beycraft.inventory.slots.SlotBeyGodChip;
...
public class BeyGodContainer extends Container {
     ...
     * @param id
     */
    public BeyGodContainer(ContainerType<?> type, int id, ItemStack stack, PlayerInventory playerInventory) {
        super(type, id);
        this.stack = stack;
